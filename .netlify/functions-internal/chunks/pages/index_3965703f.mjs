...
import 'clsx';
import { $ as $$Layout } from './_id__9fd969ef.mjs';
/* empty css                           *//* empty css                           *//* empty css                           *//* empty css                           */import { optimize } from 'svgo';
/* empty css                           */
...
const $$file$1 = "/home/futuzor/Documentos/JS/Astro/AstroAnime/src/pages/fragments/PersonList/index.astro";
const $$url$1 = "/fragments/PersonList";
...
</a></article></main><main class="characters" data-astro-cid-t2cc6qv5${addAttribute(renderTransition($$result, "mlw432tw", "slide", ""), "data-astro-transition-scope")}><h2 data-astro-cid-t2cc6qv5>Seiyuu and characters</h2>${renderComponent($$result, "PersonList", $$Index$1, { "id": anime.mal_id, "data-astro-cid-t2cc6qv5": true })}</main>`;
}, "/home/futuzor/Documentos/JS/Astro/AstroAnime/src/pages/fragments/AnimeDetails/index.astro", "self");

const $$file = "/home/futuzor/Documentos/JS/Astro/AstroAnime/src/pages/fragments/AnimeDetails/index.astro";
const $$url = "/fragments/AnimeDetails";
...
export { $$Index as $, $$Index$2 as a, index$3 as b, index$2 as c, index$1 as d, index as e, index$4 as i };
